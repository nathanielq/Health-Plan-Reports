# Health-Plan-Reports
Tech Stack - Python, Polars, concurrent.futures.ThreadPoolExecutor, Google Sheets API, Gmail API, Google Cloud Platform, HTML/CSS
