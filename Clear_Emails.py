...
teacher_emails = 'C:\\Users\\nate-sadmin\\desktop\\flex_ihp\\teacher_emails.csv'
trash_service_key = 'C:\\Users\\nate-sadmin\\desktop\\secure\\clear_emails_service_key.json'
log_file = 'C:\\nate-sadmin\\desktop\\log files\\Clear_Emails_Log.txt'
...
def Get_Email_ID(service):
    try:
        results = service.users().messages().list(userId='me', q='from:"datadashboard@mercerislandschools.org" subject:"Gator Time IHP Reports for" in:"anywhere"').execute()
